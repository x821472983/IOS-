...
//        //可选的日期
//        self.enabled = false;
//        for (int i = 0; i < _manager.canSelectDates.count; i++) {
//            if ([_manager.helper date:_date isTheSameDayThan:[[NSDate alloc] initWithTimeIntervalSinceNow: ([_manager.canSelectDates[i] intValue]-1) * 24 * 60 * 60]]) {
//                self.enabled = true;
//                break;
//            }
//        }
...
//        // 两周以外禁选
//        if ([_manager.helper date:[[NSDate alloc] initWithTimeIntervalSinceNow: 14 * 24 * 60 * 60] isBefore:_date]) {
//            self.enabled = false;
//        }
//        else{
            //可选的日期
//            self.enabled = false;
//            for (int i = 0; i < _manager.canSelectDates.count; i++) {
//                if ([_manager.helper date:_date isTheSameDayThan:[[NSDate alloc] initWithTimeIntervalSinceNow: [_manager.canSelectDates[i] intValue] * 24 * 60 * 60]]) {
//                    self.enabled = true;
//                    break;
//                }
//            }
